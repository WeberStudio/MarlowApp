            ...
            <div class="container">
            	...
            	<!--<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="http://www.youxithemes.com/live_previews/mws-admin/form_elements.html">
            	...
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span><i class="icon-ok"></i>You Can Register Here</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                    	<form id="mws-validate" class="mws-form" action="<?php echo URL.'input.php/pages/register'?>">
